...
let images = {
    ...
    setNextLeftImage() {
        ...
        currentSlide.classList.remove('hidden-slide');
        this.removeAnimationClassAfterEnd(currentSlide, 'slider-rightToLeftAnimation');
    },
    ...
    setNextRightImage() {
        ...
        currentSlide.classList.remove('hidden-slide');
        this.removeAnimationClassAfterEnd(currentSlide, 'slider-leftToRightAnimation');
    },

    /**Удаляет класс анимации с элемента animatedEl по окончании анимации
     * на этом элементе с помощью лисенера события окончания
     * @param animatedEl - элемент страницы
